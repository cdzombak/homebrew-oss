...
| [ebird-rss](https://github.com/cdzombak/ebird-rss)                                           | Generate an rss, atom, or json feed of your most recent bird sightings from an e | `brew install ebird-rss`                      |
...
| [flickr-exporter](https://github.com/cdzombak/flickr-exporter)                               | Export all your flickr photos, or a selected set or collection, preserving title | `brew install flickr-exporter`                |
...
| [hosts-timer](https://github.com/cdzombak/hosts-timer)                                       | Block websites on your system with /etc/hosts, and re-enable them on demand for  | `brew install hosts-timer`                    |
...
| [ipcam-browser](https://github.com/cdzombak/ipcam-browser)                                   | Improved media browser for sd card storage on sv3c/camhipro compatible ip webcam | `brew install ipcam-browser`                  |
...
| [mdunwrap](https://github.com/cdzombak/mdunwrap)                                             | Remove unnecessary line breaks from markdown text                                | `brew install mdunwrap`                       |
...
| [msync](https://github.com/cdzombak/msync)                                                   | Maintain a lower-bitrate copy of a music library in sync with the main copy      | `brew install msync`                          |
...
| [openweather-influxdb-connector](https://github.com/cdzombak/openweather-influxdb-connector) | Write current weather openweathermap conditions to influxdb or mqtt              | `brew install openweather-influxdb-connector` |
| [papercast-archiver](https://github.com/cdzombak/papercast-archiver)                         | Tiny web server with a ui for archiving instapaper articles. integrates with cdz | `brew install papercast-archiver`             |
| [papercast](https://github.com/cdzombak/papercast)                                           | Generate a personal podcast of your instapaper reading queue                     | `brew install papercast`                      |
...
| [purpleair2mqtt](https://github.com/cdzombak/purpleair2mqtt)                                 | Pull sensor data from your local purpleair sensors - no cloud needed             | `brew install purpleair2mqtt`                 |
...
| [raindrop-public-rss-feed](https://github.com/cdzombak/raindrop-public-rss-feed)             | Generate a public rss, atom, or json feed from your raindrop.io bookmarks tagged | `brew install raindrop-public-rss-feed`       |
...
| [wxcal](https://github.com/cdzombak/wxcal)                                                   | Generate an ical feed from the weather.gov forecast api                          | `brew install wxcal`                          |
